# Spec (delta) — closure-inventory-intelligence

> Requisitos RFC 2119 por feature. Escenarios Given/When/Then completos (~70) en engram `sdd/closure-inventory-intelligence/spec`. TDD: cada requisito tiene su test (jest in-memory BE / vitest FE).
