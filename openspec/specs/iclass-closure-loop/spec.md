...
## REQ-GS-ICLASS-DISMISSED-1 — dismissed tasks excluded from listTasksInIClassStage
...
## REQ-GS-ICLASS-INGEST-1 — IngestClosedServiceOrders skips task side-effects for dismissed tasks
...
## REQ-GS-ICLASS-CLOSEDBY-FLOW-1 — IClass-closed tasks map to generalStatus='closed'
...
## REQ-GS-ICLASS-DISMISSED-SEMANTIC-1 — Dismissed in-flight task documentation
