-- Migration: 20260730000000_pppoe_rbac_permissions
-- Seeds the 'pppoe' RBAC module + read/manage permissions +
...
-- ─── 1. Seed the pppoe module ────────────────────────────────────────────────

INSERT INTO "RbacModule" ("id", "code", "label")
VALUES (gen_random_uuid(), 'pppoe', 'PPPoE')
ON CONFLICT ("code") DO NOTHING;

-- ─── 2. Seed pppoe.read permission ───────────────────────────────────────────
...
-- ─── 3. Seed pppoe.manage permission ─────────────────────────────────────────
...
-- ─── 4. Grant pppoe.read to super_admin ──────────────────────────────────────
...
-- ─── 5. Grant pppoe.manage to super_admin ────────────────────────────────────
...
-- ─── 6. Grant pppoe.read to administrador ────────────────────────────────────
...
-- ─── 7. Grant pppoe.manage to administrador ──────────────────────────────────
