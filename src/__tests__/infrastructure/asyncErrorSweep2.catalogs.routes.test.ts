...
const cases: ReadonlyArray<SweepCase> = [
  ...
  { name: 'billing GET /summary',                       path: '/api/billing/summary',        build: () => appWith('/api/billing', createBillingRouter(f, f, f, f, fakeAuthProvider as never)) },
  { name: 'clients GET /:id/contracts',                 path: '/api/clients/99/contracts',   build: () => appWith('/api/clients', createClientsRouter(f, f, f, f, f, fakeAuthProvider as never, f, f, f, f, passthroughPerm)) },
  { name: 'contracts GET /contracts',                   path: '/api/contracts',              build: () => appWith('/api', createContractsRouter(fakeAuthProvider, f, f, f, passthroughPerm)) },
  { name: 'contractServices GET /contracts/:cid/service-history', path: '/api/contracts/c1/service-history', build: () => appWith('/api', createContractServicesRouter(fakeAuthProvider, passthroughPerm, f, f, f, f, f)) },
  { name: 'contractTechnologies GET /contract-technologies', path: '/api/contract-technologies', build: () => appWith('/api', createContractTechnologiesRouter(fakeAuthProvider, f, f, f, f, f)) },
  { name: 'deviceTypeCatalog GET /device-types',        path: '/api/device-types',           build: () => appWith('/api', createDeviceTypeCatalogRouter(fakeAuthProvider, passthroughPerm, f, f, f, f, f, catalogService)) },
  { name: 'featureFlags GET /',                         path: '/api/feature-flags',          build: () => appWith('/api/feature-flags', createFeatureFlagsRouter(fakeAuthProvider, f, f, f, pt)) },
  { name: 'gestionReal GET /sync/status',               path: '/api/gestion-real/sync/status', build: () => appWith('/api/gestion-real', createGestionRealRouter(fakeAuthProvider, f)) },
  ...
  { name: 'materialTypeCatalog GET /material-types',    path: '/api/material-types',         build: () => appWith('/api', createMaterialTypeCatalogRouter(fakeAuthProvider, passthroughPerm, f, f, f, f, f, catalogService)) },
  ...
  { name: 'projects GET /',                             path: '/api/projects',               build: () => appWith('/api/projects', createProjectsRouter(f, f, f, f, f, fakeAuthProvider)) },
  { name: 'serviceCatalog GET /service-catalog',        path: '/api/service-catalog',        build: () => appWith('/api', createServiceCatalogRouter(fakeAuthProvider, passthroughPerm, f, f, f, f)) },
  { name: 'taskCategories GET /task-categories',        path: '/api/task-categories',        build: () => appWith('/api', createTaskCategoriesRouter(fakeAuthProvider, f, f, f, f, f)) },
  { name: 'taskPriorities GET /task-priorities',        path: '/api/task-priorities',        build: () => appWith('/api', createTaskPrioritiesRouter(fakeAuthProvider, f, f, f, f, f)) },
  { name: 'taskTemplate GET /',                         path: '/api/task-templates',         build: () => appWith('/api/task-templates', createTaskTemplateRouter(f, f, f, f, f, fakeAuthProvider, f)) },
  { name: 'ticketAreas GET /',                          path: '/api/ticket-areas',           build: () => appWith('/api/ticket-areas', createTicketAreasRouter(fakeAuthProvider, passthroughPerm, f, f, f, f, f)) },
  { name: 'ticketStatuses GET /',                       path: '/api/ticket-statuses',        build: () => appWith('/api/ticket-statuses', createTicketStatusesRouter(fakeAuthProvider, f, f, f, f, f)) },
  { name: 'workflows GET /workflows',                   path: '/api/workflows',              build: () => appWith('/api', createWorkflowsRouter(fakeAuthProvider, passthroughPerm, f, f, f, f, f, f, f, f, f, f, f, f, f, f, f, f, f, f, f, f)) },
];
