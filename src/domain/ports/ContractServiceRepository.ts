...
export interface ContractServiceRepository {
  ...
  add(data: { contractId: string; serviceCatalogId: string; notes?: string | null }): Promise<ContractServiceView>;
  update(id: string, data: { status?: string; notes?: string | null }): Promise<ContractServiceView | null>;
