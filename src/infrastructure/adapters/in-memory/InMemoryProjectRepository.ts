...
export class InMemoryProjectRepository implements ProjectRepository {
  ...
  async update(id: string, data: UpdateProjectInput): Promise<Project | null> {
    ...
    const updated = {
      ...
      ...(data.allowsEquipmentRetirement !== undefined && { allowsEquipmentRetirement: data.allowsEquipmentRetirement }),
      ...(data.isNetworkProject !== undefined && { isNetworkProject: data.isNetworkProject }),
