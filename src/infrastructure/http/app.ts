...
import { InMemoryClientCommentRepository } from '../adapters/in-memory/InMemoryClientCommentRepository';
...
import { InMemoryAdminRepository } from '../adapters/in-memory/InMemoryAdminRepository';
import { createSettingsRouter } from './routes/settings.routes';
import { InMemorySettingsRepository } from '../adapters/in-memory/InMemorySettingsRepository';
...
import { InMemorySchedulingRepository } from '../adapters/in-memory/InMemorySchedulingRepository';
...
import { InMemoryVozRepository } from '../adapters/in-memory/InMemoryVozRepository';
...
import { InMemoryEmpresaRepository } from '../adapters/in-memory/InMemoryEmpresaRepository';
import { createPartnerRouter } from './routes/partner.routes';
import { InMemoryPartnerRepository } from '../adapters/in-memory/InMemoryPartnerRepository';
...
import { InMemoryRoleRepository } from '../adapters/in-memory/InMemoryRoleRepository';
...
import { InMemoryIpNetworkRepository } from '../adapters/in-memory/InMemoryIpNetworkRepository';
...
import { InMemoryNasRepository } from '../adapters/in-memory/InMemoryNasRepository';
import { createDashboardRouter } from './routes/dashboard.routes';
import { InMemoryDashboardRepository } from '../adapters/in-memory/InMemoryDashboardRepository';
...
import { InMemoryMessageRepository } from '../adapters/in-memory/InMemoryMessageRepository';
...
import { InMemoryCreditNoteRepository } from '../adapters/in-memory/InMemoryCreditNoteRepository';
import { InMemoryProformaRepository } from '../adapters/in-memory/InMemoryProformaRepository';
import { InMemoryFinanceHistoryRepository } from '../adapters/in-memory/InMemoryFinanceHistoryRepository';
...
import { InMemoryNetworkSiteRepository } from '../adapters/in-memory/InMemoryNetworkSiteRepository';
...
import { InMemoryCpeRepository } from '../adapters/in-memory/InMemoryCpeRepository';
...
import { InMemoryTr069Repository } from '../adapters/in-memory/InMemoryTr069Repository';
...
import { InMemoryHardwareRepository } from '../adapters/in-memory/InMemoryHardwareRepository';
...
import { InMemoryGponRepository } from '../adapters/in-memory/InMemoryGponRepository';
...
import { InMemoryRadiusSessionRepository } from '../adapters/in-memory/InMemoryRadiusSessionRepository';
...
import { InMemoryLeadRepository } from '../adapters/in-memory/InMemoryLeadRepository';
...
import { InMemoryUbicacionRepository } from '../adapters/in-memory/InMemoryUbicacionRepository';
...
import { InMemoryMonitoringRepository } from '../adapters/in-memory/InMemoryMonitoringRepository';
...
import { InMemoryNotificationRepository } from '../adapters/in-memory/InMemoryNotificationRepository';
...
export function createApp() {
  ...
  const authAdapter = new JwtAuthAdapter(splynxClient);
  ...
  const monitoringRepo = new InMemoryMonitoringRepository();
