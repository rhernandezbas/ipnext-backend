...
export function createAdminRouter(
  ...
  if (get2FAStatus) {
    router.get('/:id/2fa', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      try {
  ...
  if (enable2FA) {
    router.post('/:id/2fa/enable', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      try {
  ...
  if (disable2FA) {
    router.delete('/:id/2fa', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      try {
