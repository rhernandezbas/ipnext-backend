...
export function createTaskCommentsRouter(
  ...
  router.get('/:taskId/comments', auth, perms.read, async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  router.post('/:taskId/comments', auth, perms.write, async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  router.delete('/comments/:commentId', auth, perms.delete, async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
